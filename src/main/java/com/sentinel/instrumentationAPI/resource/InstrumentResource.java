...
package com.sentinel.instrumentationAPI.resource;

import javax.mail.internet.MimeMultipart;
import javax.ws.rs.*;
import javax.ws.rs.core.*;

import com.sentinel.instrumentationAPI.model.Error;
...
public interface InstrumentResource {
    ...
    InstrumentResource.PostInstrumentResponse postInstrument(MimeMultipart entity)
        throws Exception
    ;
    ...
    public class GetInstrumentByApkHashResponse
        extends com.sentinel.instrumentationAPI.server.ResponseWrapper
    {


        public GetInstrumentByApkHashResponse(Response delegate) {
            super(delegate);
        }
         ...
         *
         */
        public static InstrumentResource.GetInstrumentByApkHashResponse withJsonOK(StreamingOutput entity) {
        ...
        extends com.sentinel.instrumentationAPI.server.ResponseWrapper
    {
         ...
         *     
         */
        public static InstrumentResource.GetInstrumentResponse withJsonOK(StreamingOutput entity) {
            Response.ResponseBuilder responseBuilder = Response.status(200).header("Content-Type", "application/json");
            responseBuilder.entity(entity);
    ...
    public class PostInstrumentResponse
         ...
         *               }
         */
        public static InstrumentResource.PostInstrumentResponse withJsonAccepted(StreamingOutput entity) {
